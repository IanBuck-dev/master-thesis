...
Air temperature, relative humidity, atmospheric pressure, precipitation, and wind was sourced from Netatmo and Sensor.Community \gls{pws} networks as well as the \gls{dwd} weather stations as reference data.
