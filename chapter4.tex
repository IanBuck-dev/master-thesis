...
Next to these algorithms, there also exist less popular regression algorithms, however due to the limited scope of this work, these are the only algorithms that will be considered.
